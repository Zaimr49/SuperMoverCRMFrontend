...
// import "../styles/Dashboard.css"; // Reusing styles from Dashboard
// import {
//   FaUsers,
//   FaCheckCircle,
//   FaTimesCircle,
...
//     logout();
//   };
//   // Optional: If you have a "select all" logic, handle it here
//   const [selectAll, setSelectAll] = useState(false);

//   const handleSelectAll = (e) => {
//     setSelectAll(e.target.checked);
//     // You can also update each row's "selected" state if needed
//   };
...
//           </div>
//         </header>
//         <section className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4"></section>
...
//                         type="checkbox"
//                         checked={
//                           selectAll /* or role.selected if you track row state */
//                         }
//                         onChange={() => {} /* handle row checkbox */}
//                         className="h-4 w-4"
//                       />
//                     </td>
//                     <td className="p-3 text-left align-middle">{role.role}</td>
//                     <td className="p-3 text-left align-middle">
//                       {role.users}
//                     </td>
//                     <td className="p-3 text-left align-middle">{role.lastUpdated}</td>
